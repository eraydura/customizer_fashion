...
export function HoodieMesh({ onModelLoad, ...props }) {
  ...
  return (
    ...
    <group position={isMobile? [0,-1.8,0]:[0,-4,0]} scale={isMobile? 0.0015: 0.003}>
      <group scale={10}>
      <mesh geometry={nodes.Hat.geometry} material={materials.Knit_Fleece_Terry_FRONT_1944906} material-color={props.customColors.soul} />
      <mesh geometry={nodes.Main.geometry} material={materials['Material.001']} material-color={props.customColors.mesh}>
      <Decal
      ...
      <mesh geometry={nodes.Main001.geometry} material={materials.Material} material-color={props.customColors.mesh} />
      <mesh geometry={nodes.Pocket.geometry} material={materials['Knit_Fleece_Terry_FRONT_1944906.001']} material-color={props.customColors.stripes}/>
      </group>
    </group>
  </group>
  );
...
function Hoodie() {
  ...
  const [scale, setScale] = useState([38, 38, 38 ]);
          ...
          left: '10%', flexDirection: isMobile?'column':'row',gap: isMobile?'5px':'150px'}}>
            <div>
              ...
              <input
                ...
                style={utils.getBackgroundSize(position[0],-30,30)}
              />
            </div>
            <div>
              ...
              <input
                ...
                style={utils.getBackgroundSize(position[1],80,200)}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                style={utils.getBackgroundSize(scale[0],38,150)}
              />
            </div>
        </div>
        </div>         
